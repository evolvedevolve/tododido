...
# what about categpries
# then the description is tje avtua;l activity -
# could also have routines (morning, bedtime)
# goals as well, can maybe help with autopopulate
# things you want to do every day? habit_builder
